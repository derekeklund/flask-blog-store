...
def product_1():
    reviews = get_reviews("Mr_Garrisons_Penis") 
    # Subprime_Mug
    ...
    # GET
        ...
        # reviews = conn.execute"SELECT reviewerName, reviewTitle, reviewBody, rating FROM userReviews WHERE productID = 999;".fetchall()

        return render_template("products/subprime-mug.html", reviews=reviews)
        # avgRating=avgRating, reviewerName=reviewerName, reviewTitle=reviewTitle, reviewBody=reviewBody, reviewRating=reviewRating
        # reviews=reviews


    # conn = get_db_connection()
    # reviews = conn.execute('SELECT avgReview FROM averageReviews WHERE productName = "Subprime_Mug"').fetchall()

    # print("Reviews: ", reviews)
    # review = reviews[0]
    # print("Review: ", review)
    # review = review['avgReview']
    # print("Review: ", review)
